        ...
        <div className="min-h-screen text-slate-100 px-4 py-24 relative overflow-hiddenbg-[radial-gradient(ellipse_at_top,_#0f172a_0%,_#020617_60%,_#020617_100%)]">
            ...
            <div className="max-w-7xl mx-auto relative z-10">
                ...
                <div className="text-center mb-20 relative">
                    ...
                    <h1 className="text-4xl lg:text-6xl font-bold tracking-tight relative">PLL</h1>
                    <p className="text-slate-400 mt-4 relative">Permutation of Last Layer Algorithms</p>
                </div>
